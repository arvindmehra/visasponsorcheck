# Lookup utility for UK Standard Industrial Classification (SIC) 2007 code descriptions.
# Contains the condensed list from Companies House.
# Source: https://www.gov.uk/government/publications/standard-industrial-classification-of-economic-activities-sic
class SicCodeLookup
  # Returns the description for a given SIC code, or nil if not found.
  ...
  DESCRIPTIONS = {
    ...
    "01430" => "Raising and breeding of horses and other equines",
    ...
    "17219" => "Manufacture of other articles of paper and paperboard",
    ...
    "28930" => "Manufacture of machinery for food, beverages and tobacco processing",
    ...
    "46439" => "Wholesale of radio, television and photographic goods and electrical household appliances (other than records, tapes, CDs \u0026 video tapes and the equipment used for playing them)",
    ...
    "47599" => "Retail of furniture, lighting, and similar (not musical instruments and scores) in specialised store",
    ...
    "47789" => "Other retail sale of new goods in specialised stores (not incl. commercial art galleries and opticians)",
    ...
    "49319" => "Other urban, suburban or metropolitan area passenger land transport (not underground, metro or similar)",
    ...
    "52211" => "Operation of bus and coach terminal facilities",
    "52212" => "Operation of railway passenger facilities at railway stations",
    "52213" => "Operation of railway freight terminal facilities",
