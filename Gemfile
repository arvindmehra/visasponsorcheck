...
# Friendly URL slugs [https://github.com/norman/friendly_id]
gem "friendly_id", "~> 5.5"
...
group :development, :test do
  ...
  # Faker for realistic test data [https://github.com/faker-ruby/faker]
  gem "faker"
...
group :test do
  # Shoulda matchers for concise model specs [https://github.com/thoughtbot/shoulda-matchers]
